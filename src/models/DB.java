...
public class DB {
    ...
    private static final String DB_DEFAULT_DATABASE = "zwierins2";
    private static final String DB_DEFAULT_SERVER_URL = "oege.ie.hva.nl";
    private static final String DB_DEFAULT_ACCOUNT = "wierins2";
    private static final String DB_DEFAULT_PASSWORD = "uF59B7bJXKKJV.";
